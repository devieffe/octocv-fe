...
const Hero = () => {
  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full py-20 lg:py-0 relative z-20">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          <motion.div variants={stagger} initial="hidden" animate="visible" className="space-y-7 pt-8 pb-[80px]">
            ...
            <motion.p variants={fadeUp} className={`text-base sm:text-lg leading-relaxed max-w-lg ${isDark ? "text-gray-400" : "text-slate-600"}`}>
          ...
          <motion.div
            ...
            className="relative z-[60] flex justify-center items-center w-full"
            aria-hidden="true"
          >
            <div className="relative z-[60] w-full max-w-[414px] sm:max-w-[552px] lg:max-w-[690px] flex items-center justify-center">
              ...
              >
                <div className="flex items-center gap-2">
                  <div className="w-8 h-8 sm:w-9 sm:h-9 rounded-xl bg-green-500/15 flex items-center justify-center">
                    <CheckCircle size={16} className="text-green-400 sm:w-[18px] sm:h-[18px]" />
                  </div>
                  <div>
                    <p className={`text-[10px] sm:text-[11px] ${bubbleLabelClass}`}>CV Score</p>
                    <p className={`text-xs sm:text-sm font-bold ${bubbleTextClass}`}>96 / 100</p>
                  </div>
                </div>
              </motion.div>
              ...
              >
                <div className="flex items-center gap-2">
                  <div className="w-8 h-8 sm:w-9 sm:h-9 rounded-xl bg-red-500/15 flex items-center justify-center">
                    <TrendingUp size={16} className="text-red-400 sm:w-[18px] sm:h-[18px]" />
                  </div>
                  <div>
                    <p className={`text-[10px] sm:text-[11px] ${bubbleLabelClass}`}>Match Rate</p>
                    <p className={`text-xs sm:text-sm font-bold ${bubbleTextClass}`}>+95%</p>
                  </div>
                </div>
              </motion.div>
              ...
              >
                <div className="flex items-center gap-2">
                  <div className="w-8 h-8 sm:w-9 sm:h-9 rounded-xl bg-red-500/15 flex items-center justify-center">
                    <Award size={16} className="text-red-400 sm:w-[18px] sm:h-[18px]" />
                  </div>
                  <div>
                    <p className={`text-[10px] sm:text-[11px] ${bubbleLabelClass}`}>AI Match</p>
                    <p className={`text-xs sm:text-sm font-bold ${bubbleTextClass}`}>92% fit</p>
                  </div>
                </div>
              </motion.div>
            </div>
